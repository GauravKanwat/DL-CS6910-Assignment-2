...
def configParse():
    ...
    parser.add_argument('-bn', '--batch_norm', type = str, default = "No", help='batch normalization')
    ...
    parser.add_argument('-nf', '--num_filters', type = int, default = 8, help='number of filters')
    parser.add_argument('-fs', '--filter_size', type = int, default = 5, help='filter size')
    parser.add_argument('-af', '--activation_function', type = str, default = "GELU", help='activation function')
    parser.add_argument('-fm', '--filter_multiplier', type = float, default = 2, help='filter multiplier')
